...
Your environment includes three pre-provisioned namespaces:
...
You have a custom `tenant-user` role in each namespace. This gives you access to your namespaces, but you can't see view Secrets nor their values - you're a developer, not an admin!
